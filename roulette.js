...
<head>
    ...
    var array;
    function arrays () {
        array = [];//配列として空のarrayを定義
        for (var i=1; i<=16; i++) {//1~16までの値(i)を繰り返し処理
        ...
        function show_roulette () {//show_roulette()関数を定義(ルーレットの抽選時の処理を行う)
